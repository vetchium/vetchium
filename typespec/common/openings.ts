export type OpeningState = 'DRAFT_OPENING_STATE' | 'ACTIVE_OPENING_STATE' | 'SUSPENDED_OPENING_STATE' | 'CLOSED_OPENING_STATE';
...
export type OpeningType = 'FULL_TIME_OPENING' | 'PART_TIME_OPENING' | 'CONTRACT_OPENING' | 'INTERNSHIP_OPENING' | 'UNSPECIFIED_OPENING';
...
export type EducationLevel = 'BACHELOR_EDUCATION' | 'MASTER_EDUCATION' | 'DOCTORATE_EDUCATION' | 'NOT_MATTERS_EDUCATION' | 'UNSPECIFIED_EDUCATION';
