export type ApplicationState = 'APPLIED' | 'REJECTED' | 'SHORTLISTED' | 'WITHDRAWN' | 'EXPIRED';
...
export function isValidApplicationState(state: string): state is ApplicationState {
