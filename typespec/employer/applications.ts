...
export function isValidApplicationColorTag(tag: string): tag is ApplicationColorTag {
    return Object.values(ApplicationColorTags).includes(tag as ApplicationColorTag);
} 