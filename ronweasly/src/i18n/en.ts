export const en = {
  ...
  incognitoPosts: {
    ...
    subtitle: "Share and discuss anonymously",
    createPost: "Create Incognito Post",
    ...
    compose: {
      title: "Create Anonymous Post",
      contentPlaceholder: "Share your thoughts anonymously...",
      contentLabel: "Content",
      tagsLabel: "Tags",
      tagsPlaceholder: "Select 1-3 tags",
      ...
      contentTooLong: "Content is too long (max 1024 characters)",
      posting: "Posting...",
    },
    post: {
      viewDetails: "View Details",
      deletePost: "Delete Post",
      confirmDelete: "Are you sure you want to delete this anonymous post?",
      ...
      votingDisabled: "You cannot vote on your own post",
      alreadyVoted: "You have already voted on this post",
    },
    comments: {
      title: "Comments",
      ...
      replyPlaceholder: "Add your reply...",
      posting: "Posting...",
      deleteComment: "Delete Comment",
      confirmDeleteComment: "Are you sure you want to delete this comment?",
      deleted: "This comment has been deleted",
      contentRequired: "Comment content is required",
      contentTooLong: "Comment is too long (max 512 characters)",
      maxDepthReached: "Maximum reply depth reached",
      parentDeleted: "Cannot reply to deleted comment",
    },
    filters: {
    ...
    myPosts: {
      title: "My Anonymous Posts",
      noPosts: "You haven't created any anonymous posts yet",
      totalPosts: "Total Posts",
      createFirst: "Create your first anonymous post",
    },
    myComments: {
      title: "My Anonymous Comments",
      noComments: "You haven't made any anonymous comments yet",
    ...
    feed: {
      noPosts: "No posts found for the selected criteria",
      noPostsForTag: "No posts found for this tag",
      loadMore: "Load More Posts",
      noMorePosts: "No more posts to load",
      refreshFeed: "Refresh Feed",
      selectTagFirst: "Select a tag to view anonymous posts",
    },
    voting: {
      upvote: "Upvote",
      downvote: "Downvote",
      unvote: "Remove Vote",
      cannotVoteOwn: "Cannot vote on your own content",
      alreadyUpvoted: "Already upvoted",
      alreadyDownvoted: "Already downvoted",
      voteRemoved: "Vote removed",
      votingError: "Error updating vote",
    },
    errors: {
      ...
      voteFailed: "Failed to update vote",
    ...
    success: {
      postCreated: "Anonymous post created successfully",
      postDeleted: "Anonymous post deleted successfully",
