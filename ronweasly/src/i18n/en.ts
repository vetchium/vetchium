export const en = {
  ...
  incognitoPosts: {
    ...
    post: {
      ...
      title: "Incognito Post",
      loadMoreComments: "Load More Comments",
      loading: "Loading...",
      noCommentsYet: "No comments yet. Be the first to comment!",
      addingComment: "Adding new comment...",
      ...
      delete: "Delete",
      you: "(you)",
      loadMoreReplies: "Load {count} more replies",
    ...
    errors: {
      ...
      cannotVoteComment:
        "Cannot vote on this comment. You may have already voted in the opposite direction or it may be your own comment.",
      cannotUnvoteComment:
        "Cannot remove vote from this comment. It may be your own comment.",
      mustBeLoggedIn: "You must be logged in to vote.",
      voteFailedGeneric: "Vote failed. Please try again.",
      voteFailedShort: "Vote failed",
    },
    success: {
