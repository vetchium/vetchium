...
VALUES
    ('12345678-0011-0011-0011-000000050001'::uuid, 'Active Hub User', 'active_hub_user', '0011-active@hub.example', '$2a$10$p7Z/hRlt3ZZiz1IbPSJUiOualKbokFExYiWWazpQvfv660LqskAUK', 'ACTIVE_HUB_USER', 'FREE_HUB_USER', 'USA', 'New York', 'en', 'Active Hub User is analytical', 'Active Hub User was born in USA and finished education at Columbia University and has 4 years as experience.', timezone('UTC'::text, now()));
