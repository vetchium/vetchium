...
INSERT INTO public.emails (email_key, email_from, email_to, email_cc, email_bcc, email_subject, email_html_body, email_text_body, email_state, created_at, processed_at)
    VALUES ('12345678-0004-0004-0004-000000000011'::uuid, 'no-reply@vetchi.org', ARRAY['admin@orgusers.example'], NULL, NULL, 'Welcome to Vetchium Subject', 'Welcome to Vetchium HTML Body', 'Welcome to Vetchium Text Body', 'PROCESSED', timezone('UTC'::text, now()), timezone('UTC'::text, now()));
...
INSERT INTO public.employers (id, client_id_type, employer_state, company_name, onboard_admin_email, onboard_secret_token, token_valid_till, onboard_email_id, created_at)
    VALUES ('12345678-0004-0004-0004-000000000201'::uuid, 'DOMAIN', 'ONBOARDED', 'orgusers.example', 'admin@orgusers.example', 'blah', timezone('UTC'::text, now()) + interval '1 day', '12345678-0004-0004-0004-000000000011'::uuid, timezone('UTC'::text, now()));
...
INSERT INTO public.employer_primary_domains (employer_id, domain_id)
    VALUES ('12345678-0004-0004-0004-000000000201'::uuid, '12345678-0004-0004-0004-000000003001'::uuid);
