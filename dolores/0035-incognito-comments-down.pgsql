-- Cleanup data for 0035-incognito-comments_test.go
...
WHERE comment_id IN (
    ...
    WHERE ip.author_id LIKE '12345678-0035-%'
);

-- Delete incognito post votes
DELETE FROM incognito_post_votes 
WHERE incognito_post_id IN (
    SELECT id FROM incognito_posts WHERE author_id LIKE '12345678-0035-%'
);
...
DELETE FROM incognito_posts WHERE author_id LIKE '12345678-0035-%';

-- Delete hub users created for this test
DELETE FROM hub_users WHERE id LIKE '12345678-0035-%'; 