...
WHERE comment_id IN (
    ...
    WHERE ip.author_id LIKE '12345678-0037-%'
);

-- Delete incognito post votes
DELETE FROM incognito_post_votes 
WHERE incognito_post_id IN (
    SELECT id FROM incognito_posts WHERE author_id LIKE '12345678-0037-%'
);
...
DELETE FROM incognito_posts WHERE author_id LIKE '12345678-0037-%';

-- Delete hub users created for this test
DELETE FROM hub_users WHERE id LIKE '12345678-0037-%'; 