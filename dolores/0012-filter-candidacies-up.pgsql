...
VALUES
    ('12345678-0011-0011-0011-000000060001'::uuid, 'Applicant One', 'applicant1', 'applicant1@hub.example', '$2a$10$p7Z/hRlt3ZZiz1IbPSJUiOualKbokFExYiWWazpQvfv660LqskAUK', 'ACTIVE_HUB_USER', 'USA', 'New York', 'en', 'Applicant One is innovative', 'Applicant One was born in USA and finished education at NYU and has 4 years as experience.', timezone('UTC'::text, now()), timezone('UTC'::text, now())),
    ('12345678-0011-0011-0011-000000060002'::uuid, 'Applicant Two', 'applicant2', 'applicant2@hub.example', '$2a$10$p7Z/hRlt3ZZiz1IbPSJUiOualKbokFExYiWWazpQvfv660LqskAUK', 'ACTIVE_HUB_USER', 'IND', 'Bangalore', 'en', 'Applicant Two is dedicated', 'Applicant Two was born in India and finished education at IISc Bangalore and has 6 years as experience.', timezone('UTC'::text, now()), timezone('UTC'::text, now())),
    ('12345678-0011-0011-0011-000000060003'::uuid, 'Applicant Three', 'applicant3', 'applicant3@hub.example', '$2a$10$p7Z/hRlt3ZZiz1IbPSJUiOualKbokFExYiWWazpQvfv660LqskAUK', 'ACTIVE_HUB_USER', 'GBR', 'London', 'en', 'Applicant Three is resourceful', 'Applicant Three was born in UK and finished education at Imperial College London and has 5 years as experience.', timezone('UTC'::text, now()), timezone('UTC'::text, now()));
