...
WHERE employer_id = '12345678-0006-0006-0006-000000000201'::uuid;
...
WHERE id = '12345678-0006-0006-0006-000000000201'::uuid;

DELETE FROM emails
WHERE email_key = '12345678-0006-0006-0006-000000000011'::uuid;
